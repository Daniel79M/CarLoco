...
<div class="wrap-content">
    <br /><br />
    <form action="{{ route('categories.update', $category->id) }}" method="POST" class="container mt-5 p-4 border rounded shadow-sm bg-light">
        @csrf
        @method("PATCH")
        ...
        <div class="mb-3">
            ...
            <textarea name="description" id="description" rows="3" class="form-control" placeholder="Saisir la description ...">{{ $category->description }}</textarea>
        </div>
